...
These labels are exactly matched by the network's system rules; terms in the legal contracts between all of the participants, stating penalties for not obeying the permission labels.
